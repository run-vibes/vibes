...
- [ ] All stories use `[TYPE][NNNN]-verb-phrase.md` format
- [ ] All frontmatter `id:` fields updated
- [ ] Milestone-prefixed stories have `milestone:` in frontmatter
- [ ] All epic symlinks resolve correctly
- [ ] `just board generate` succeeds
- [ ] `just board status` shows correct counts
